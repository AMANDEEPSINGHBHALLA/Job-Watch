...
app.post("/upload", upload.single("resume"), async (req, res) => {
  try{
    ...
    async function run() {
      ...
      const prompt = "Based on my resume, please recommend job profiles that align with my skills and experience. Highlight roles that best match my qualifications and interests, focusing on [mention key skills or technologies]. Identify specific job titles and industries where I would be a strong fit, considering my career goals and expertise. Please present the results with valid and appropriate HTML formatting to ensure readability.";
    
      const imageParts = [
        fileToGenerativePart("public/img/" + resume_name, "image/png"),
      ];
